        ...
        <div class="col-md-8 col-12">
            ...
            <div class="col-1 steps">
              <ul class="p-0">
                <li
                  class="pointer-event"
                  @click="step = 1"
                  :class="{ 'active-doted': step === 1 }"
                >
                  <span :class="{ 'bg-green': step <= 1 }">
                    1
                  </span>
                </li>
                <li
                  class="pointer-event"
                  @click="step = 2"
                  :class="{ 'active-doted': step === 2 }"
                >
                  <span :class="{ 'bg-green': step < 2 }">2</span>
                </li>
                <li
                  class="pointer-event"
                  @click="step = 3"
                  :class="{ 'active-doted': step === 3 }"
                >
                  <span :class="{ 'bg-green': step < 3 }">3</span>
                </li>
              </ul>
            </div>
            <div class="col-11">
              <div class="create-voucher" v-if="step === 1">
                ...
                <div class="status-voucher d-flex justify-content-between ">
                  <div class="tree-balance param-sm tr-green">
                    <span>Tree Balance: </span><span>38</span>
                  </div>
                  <div class="eth-balance param-sm tr-green">
                    <span>ETH Balance: </span><span>4.0865 </span>
                  </div>
                </div>
                ...
                <div class="trees-per-voucher mt-4">
                  ...
                  <span
                    ><label for="trees-per-voucher"
                      ><input
                        id="trees-per-voucher"
                        type="text"
                        placeholder="1"
                        class="form-control-lg"
                        v-model="treesPerVoucher"/></label
                  ></span>
                  <span
                    class="plus position-relative"
                    @click="treesPerVoucher += 1"
                    ><p>+</p>
                  </span>
                </div>
                <div class="title mt-4">
                ...
                <div
                  class="trees-per-voucher total-vouchers-to-distribute mt-4"
                >
                  <span
                    class="odd position-relative"
                    @click="
                      totalVouchersToDistribute > 0
                        ? (totalVouchersToDistribute -= 1)
                        : totalVouchersToDistribute
                    "
                  >
                    <p>-</p></span
                  >
                  <span
                    ><label for="total-vouchers-to-distribute "
                      ><input
                        id="total-vouchers-to-distribute "
                        type="text"
                        placeholder="1"
                        class="form-control-lg"
                        v-model="totalVouchersToDistribute"/></label
                  ></span>
                  <span
                    class="plus position-relative"
                    @click="totalVouchersToDistribute += 1"
                    ><p>+</p>
                  </span>
                </div>
                <div class="submit mt-4">
                  <button
                    class="color-white text-white bg-light-green btn-lg"
                    @click="step = 2"
                  >
                    Next
                  </button>
                ...
                <div class="step-two">
                  <p class="param-md tr-gray-one">
                    Approve to Collect Trees for Creating Vouchers
                  </p>
                </div>
              ...
              <div class="create-voucher-two" v-if="step === 2">
                <div class="title">
                  ...
                  <h2
                    class="param-lg font-weight-bold  mt-4"
                    style="color: #616161"
                  >
                    Approve collecting
                    <span style="color: #67b68c" class="tr-green">1 tree</span>
                    from your forest to generate vouchers.
                  </h2>
                  <p class="param-md text-danger mt-4">
              ...
              <div class="create-voucher-three" v-if="step === 3">
                <div class="title">
                  ...
                  <div class="step-two">
                    <p class="param-md tr-gray-one mb-0 mt-4">
                      Approve to Collect Trees for Creating Vouchers
                    </p>
                    <span
                      ><a
                        href=""
                        class="tr-gray-ten text-black-50 param-sm border-right pr-2"
                        >Vouchers Generated</a
                      ></span
                    >
                    <span
                      ><a
                        href=""
                        class="tr-green param-sm"
                        style="color: #67b68c"
                        >See Details</a
                      ></span
                    >
                  ...
                  <h2
                    class="param-lg font-weight-bold  mt-3"
                    style="color: #616161"
                  >
                    Approve spending
                    <span style="color: #67b68c" class="tr-green"
                      >0.002 ETH</span
                    >
                    from your wallet for service fee.
                  </h2>
                  <p class="param-md text-danger mt-4">
                    Please do not close this page!
                  </p>
              ...
              <div class="create-voucher-four" v-if="step === 4">
                ...
                <div class="final-box">
                  <div class="header">
                    ...
                    <p class="param-sm">
                      Receive your vouchers via email or download them right
                      away. You can always access vouchers from "My Vouchers"
                      tab.
                    </p>
                  </div>
                  <div class="body ">
                    <form class="d-flex" action="" @submit="addTreeFinalStep()">
                      <div class="final-box-input">
                        <input
                          class="form-control-lg"
                          v-model="email"
                          place-holder="Enter your email here"
                        />
                      </div>
          ...
          <div id="my_voucher" v-if="activeIndex === 1" class="row mt-4">
            <div class="col-12 ">
              <div
                v-if="myVoucher"
                class="card-voucher d-flex flex-row justify-content-around align-items-center align-self-center"
                v-for="(item, index) in myVoucher"
                :key="index"
              >
                <div class="tree-count">
                  <p class="param-md tr-black">
                    <span>{{ item.tree }}</span
                    ><span>tree</span>
                  </p>
                </div>
                ...
                <div class="download">
                  <p>
                    <a :href="item.href" class="param-md tr-green"
                      ><span>Download</span
                      ><span><Fas i="external-link-alt"/></span
                    ></a>
                  </p>
                </div>
              </div>
