export default {
  ...
  alert: {
    ...
    checkprogressonetherscan: "Check progress on Explorer",
  ...
  aboutus: {
    ...
    unique: "A unique borderless approach in Climate Action powered by blockchain",
  ...
  forest: {
    ...
    meta: {
      ...
      keywords: "treejer,treejer forest,NFTTree,treeNFT,forest page, forest profile",
    },
  },
  sidebar: {
    myforest: "My Forest",
  ...
  treebox: {
    treebox: "Treebox",
    description: "Plant trees and send them as gift with a personal message. TreeBox recipients don’t need to have a web 3.0 wallet to recieve NFT trees.",
