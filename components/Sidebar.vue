<template>
  <section class="sidebar pt-4 col-lg-2 d-md-block">
    <ul class="nav flex-column  " >
      ...
      >
        ...
        >
          <svg fill="none" height="32" viewBox="0 0 32 32" width="32" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0" height="32" mask-type="alpha" maskUnits="userSpaceOnUse" width="32" x="0" y="0">
              <path :fill="$store.state.index === 0 ? 'white' : '#C4C4C4'"
                    d="M32 0L32 32L-1.39876e-06 32L0 -1.39876e-06L32 0Z"/>
            </mask>
            <g mask="url(#mask0)">
              <path
                :stroke="$store.state.index === 0 ? 'white' : '#616161'"
                ...
                stroke-width="1.4"/>
              <path :stroke="$store.state.index === 0 ? 'white' : '#616161'" d="M8.65186 11.4419L8.65185 27.7674"
                    stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4"/>
              <path :stroke="$store.state.index === 0 ? 'white' : '#616161'" d="M16.8145 9.17407L16.8145 27.767"
                    stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4"/>
              <path :stroke="$store.state.index === 0 ? 'white' : '#616161'" d="M23.1626 14.1627L23.1626 27.7673"
                    stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4"/>
              <path :stroke="$store.state.index === 0 ? 'white' : '#616161'"
                    d="M16.7939 15.7299C16.7939 15.7299 20.9102 13.7796 21.5605 10.3137" stroke-linecap="round"
                    stroke-linejoin="round"
                    stroke-width="1.4"/>
              <path :stroke="$store.state.index === 0 ? 'white' : '#616161'"
                    d="M8.28333 17.409C8.28333 17.409 4.81666 17.6232 5.03317 13.7202" stroke-linecap="round"
                    stroke-linejoin="round"
                    stroke-width="1.4"/>
              <path :stroke="$store.state.index === 0 ? 'white' : '#616161'"
                    d="M23.3965 18.5282C23.3965 18.5282 26.4124 18.7688 27.1085 15.9797" stroke-linecap="round"
                    stroke-linejoin="round"
                    stroke-width="1.4"/>
              <path
                :stroke="$store.state.index === 0 ? 'white' : '#616161'"
      ...
      <li class="nav-item referral"
          @click="changeIndex(1)"
      >
        <nuxt-link :class="$store.state.index=== 1 ?'nuxt-link-exact-active':''"
                   class="nav-link"
                   to="/forest/referral"
        >
          <svg fill="none" height="31" viewBox="0 0 25 31" width="25" xmlns="http://www.w3.org/2000/svg">
            <path
              :stroke="$store.state.index === 1? 'white' : '#757575'"
              d="M11.1544 11.629C8.77952 11.2094 7.14901 10.5697 5.98043 9.46676C4.81583 8.36759 4.01349 6.71611 3.50096 4.06321C3.41264 3.60602 3.82873 3.21087 4.2999 3.34309C6.58151 3.98331 8.18389 4.74262 9.35475 5.86703C10.517 6.98311 11.3251 8.52819 11.8788 10.879C11.9804 11.3101 11.6138 11.7102 11.1544 11.629Z" stroke-width="1.5"/>
            <path
              :stroke="$store.state.index === 1? 'white' : '#757575'"
              d="M11.1544 24.2638C8.77952 23.8442 7.14901 23.2045 5.98043 22.1015C4.81583 21.0024 4.01349 19.3509 3.50096 16.698C3.41264 16.2408 3.82873 15.8456 4.2999 15.9779C6.58151 16.6181 8.18389 17.3774 9.35475 18.5018C10.517 19.6179 11.3251 21.163 11.8788 23.5137C11.9804 23.9449 11.6138 24.3449 11.1544 24.2638Z" stroke-width="1.5"/>
            <path
              :stroke="$store.state.index === 1? 'white' : '#757575'"
              d="M13.3877 18.2638C15.7626 17.8442 17.3931 17.2045 18.5617 16.1015C19.7263 15.0024 20.5286 13.3509 21.0412 10.698C21.1295 10.2408 20.7134 9.84564 20.2422 9.97785C17.9606 10.6181 16.3582 11.3774 15.1874 12.5018C14.0252 13.6179 13.217 15.163 12.6633 17.5137C12.5617 17.9449 12.9283 18.3449 13.3877 18.2638Z" stroke-width="1.5"/>
            <line :stroke="$store.state.index === 1? 'white' : '#757575'" stroke-linecap="round" stroke-width="1.5"
                  x1="12.25" x2="12.25"
                  y1="2.38477" y2="29.8848"/>
          </svg>
      ...
      <li class="nav-item Leaderboard"
          @click="changeIndex(2)"
      >
        <nuxt-link :class="$store.state.index=== 2 ?'nuxt-link-exact-active':''"
                   class="nav-link"
        ...
        >
          <svg fill="none" height="32" viewBox="0 0 32 32" width="32" xmlns="http://www.w3.org/2000/svg">
            ...
            <g mask="url(#mask0)">
              <path
                :stroke="$store.state.index === 2 ? 'white' :'#757575'"
      ...
      <li class="nav-item updates"
          @click="changeIndex(3)"
      >
        <nuxt-link :class="$store.state.index=== 3 ?'nuxt-link-exact-active':''"
                   class="nav-link"
                   to="/forest/activity"
        ...
        >
          <svg fill="none" height="32" viewBox="0 0 32 32" width="32" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0" height="32" mask-type="alpha" maskUnits="userSpaceOnUse" width="32" x="0" y="0">
              <path :fill="$store.state.index === 3 ? 'none' :'#C4C4C4' "
                    d="M32 0L32 32L-1.39876e-06 32L0 -1.39876e-06L32 0Z"/>
            </mask>
            <g mask="url(#mask0)">
              <path
                :stroke="$store.state.index === 3 ? 'white' :'#616161'"
      ...
      >
        <a class="nav-link pointer-event"
