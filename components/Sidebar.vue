  ...
  <section class="sidebar pt-4 col-lg-2 d-md-block">
    <ul class="nav flex-column  ">
      <li class="nav-item forest"
          @click="changeIndex(0)"
      >
        <nuxt-link :class="activeIndex=== 0 ?'nuxt-link-exact-active':''"
        ...
        >
          <svg fill="none" height="32" viewBox="0 0 32 32" width="32" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0" height="32" mask-type="alpha" maskUnits="userSpaceOnUse" width="32" x="0" y="0">
              <path :fill="activeIndex === 0 ? 'white' : '#C4C4C4'"
                    d="M32 0L32 32L-1.39876e-06 32L0 -1.39876e-06L32 0Z"/>
            </mask>
            <g mask="url(#mask0)">
              <path
                :stroke="activeIndex === 0 ? 'white' : '#616161'"
                ...
                stroke-width="1.4"/>
              <path :stroke="activeIndex === 0 ? 'white' : '#616161'" d="M8.65186 11.4419L8.65185 27.7674"
                    stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4"/>
              <path :stroke="activeIndex === 0 ? 'white' : '#616161'" d="M16.8145 9.17407L16.8145 27.767"
                    stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4"/>
              <path :stroke="activeIndex === 0 ? 'white' : '#616161'" d="M23.1626 14.1627L23.1626 27.7673"
                    stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4"/>
              <path :stroke="activeIndex === 0 ? 'white' : '#616161'"
      ...
      <li class="nav-item Leaderboard"
          @click="changeIndex(1)"
      >
        <nuxt-link :class="activeIndex=== 1 ?'nuxt-link-exact-active':''"
                   class="nav-link"
                   to="/leaderboard"
        >
          <svg fill="none" height="32" viewBox="0 0 32 32" width="32" xmlns="http://www.w3.org/2000/svg">
            ...
            <g mask="url(#mask0)">
              <path
                :stroke="activeIndex === 1 ? 'white' :'#757575'"
      ...
      <li class="nav-item updates"
          @click="changeIndex(2)"
      >
        <nuxt-link :class="activeIndex=== 2 ?'nuxt-link-exact-active':''"
                   class="nav-link"
                   to="/updates"
        ...
        >
          <svg fill="none" height="32" viewBox="0 0 32 32" width="32" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask0" height="32" mask-type="alpha" maskUnits="userSpaceOnUse" width="32" x="0" y="0">
              <path :fill="activeIndex === 2 ? 'none' :'#C4C4C4' "
                    d="M32 0L32 32L-1.39876e-06 32L0 -1.39876e-06L32 0Z"/>
            </mask>
            <g mask="url(#mask0)">
              <path
                :stroke="activeIndex === 2 ? 'white' :'#616161'"
